  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard title="Totale Proprietari" value="1,248" trend="+5.2%" isUp={true} icon="📊" color="bg-blue-100" />
        <StatCard title="Chiamate Oggi" value="32" trend="-2.4%" isUp={false} icon="📞" color="bg-green-100" />
        <StatCard title="Lead Caldi" value="84" trend="+12.8%" isUp={true} icon="🔥" color="bg-red-100" />
        <StatCard title="Appuntamenti" value="18" trend="+2" isUp={true} icon="📅" color="bg-purple-100" />
      </div>
